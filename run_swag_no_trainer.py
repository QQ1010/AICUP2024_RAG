...
def main():
    ...
    if args.dataset_name is not None:
        ...
        modified_datasets = raw_datasets.map(
            lambda example: {
                **example,
                "answer": {
                ...
                "ending0": context_file[example['paragraphs'][0]],
                "ending1": context_file[example['paragraphs'][1]],
                "ending2": context_file[example['paragraphs'][2]],
                "ending3": context_file[example['paragraphs'][3]],
                "sent1": example['question'],
                "sent2": "",
                "label": next((i for i, p in enumerate(example['paragraphs']) if p == example['relevant']), None)
            }
        )
        raw_datasets = modified_datasets
    ...
    def preprocess_function(examples):
        ...
        # logger.info(type(first_sentences))
        # logger.info(type(second_sentences))
